...
leResult screenShow_Home(void)
{
    ...
    Home_BackgroundPanel->fn->setSize(Home_BackgroundPanel, 480, 272);
    ...
    Home_ImageWidgetMCHPLogo->fn->setPosition(Home_ImageWidgetMCHPLogo, 30, 30);
    ...
    Home_ImageWidgetMGSLogo->fn->setPosition(Home_ImageWidgetMGSLogo, 255, 150);
    ...
    Home_ButtonWidgetQuickStart->fn->setPosition(Home_ButtonWidgetQuickStart, 280, 25);
    ...
    Home_LabelWidget_0->fn->setPosition(Home_LabelWidget_0, 96, 88);
    Home_LabelWidget_0->fn->setSize(Home_LabelWidget_0, 90, 40);
    ...
    Home_LabelWidget_1->fn->setPosition(Home_LabelWidget_1, 93, 138);
    Home_LabelWidget_1->fn->setSize(Home_LabelWidget_1, 96, 45);
    ...
    Home_LabelWidget_2->fn->setPosition(Home_LabelWidget_2, 69, 187);
    Home_LabelWidget_2->fn->setSize(Home_LabelWidget_2, 122, 45);
